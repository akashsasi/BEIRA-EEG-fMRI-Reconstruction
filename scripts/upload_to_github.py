...
def upload_new_repo(root: Path, token: str, repo: dict, branch: str) -> str:
    ...
    commit_payload = {
        "message": "Initial commit: add BEIRA project",
...
def main() -> None:
    ...
    url = upload_new_repo(root, token, repo, args.branch)
